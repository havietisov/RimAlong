...
namespace CooperateRim
{
    ...
    public static class ExpressionHelper
    {
        ...
        public static MethodInfo GetMethodInfo<T,T2>(Expression<Action<T,T2>> expression)
        {
            return GetMethodInfo((LambdaExpression)expression);
        }

        public static MethodInfo GetMethodInfo<T, T2, T3>(Expression<Action<T, T2, T3>> expression)
        {
            return GetMethodInfo((LambdaExpression)expression);
        }

        public static MethodInfo GetMethodInfo<T, T2, T3, T4>(Expression<Action<T, T2, T3, T4>> expression)
        {
            return GetMethodInfo((LambdaExpression)expression);
        }
