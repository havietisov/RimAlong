...
public class designator_forbid_methods : common_patch_fields
{
    public static void parrot_designate_thing(Thing t)
    {
        ...
        try
        {
            DesignatorUtility.FindAllowedDesignator<Designator_Forbid>().DesignateThing(t);
        }
        finally
        {
            use_native = false;
    ...
    public static void parrot_designate_cell(IntVec3 c)
    {
        ...
        try
        {
            DesignatorUtility.FindAllowedDesignator<Designator_Forbid>().DesignateSingleCell(c);
        }
        finally
        {
            use_native = false;
