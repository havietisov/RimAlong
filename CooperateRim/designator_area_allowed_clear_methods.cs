...
public class designator_area_allowed_clear_methods : common_patch_fields
{
    public static void parrot_designate_single_cell(IntVec3 c, Area z)
    {
        ...
        try
        {
            ...
            DesignatorUtility.FindAllowedDesignator<Designator_AreaAllowedClear>().DesignateSingleCell(c);
